...
W_fc1 = tf.Variable(tf.zeros([3136, 1024]))
W_fc2 = tf.Variable(tf.zeros([1024, 10]))
b_conv1 = tf.Variable(tf.zeros([32,]))
b_conv2 = tf.Variable(tf.zeros([64,]))
b_fc1 = tf.Variable(tf.zeros([1024,]))
b_fc2 = tf.Variable(tf.zeros([10,]))
h_conv1 = tf.placeholder(tf.float32, [None, 28, 28, 32])
h_conv2 = tf.placeholder(tf.float32, [None, 14, 14, 64])
h_fc1 = tf.placeholder(tf.float32, [None, 1024])
h_fc1_drop = tf.placeholder(tf.float32, [None, 1024])
h_pool1 = tf.placeholder(tf.float32, [None, 14, 14, 32])
h_pool2 = tf.placeholder(tf.float32, [None, 7, 7, 64])
h_pool2_flat = tf.placeholder(tf.float32, [None, 3136])
