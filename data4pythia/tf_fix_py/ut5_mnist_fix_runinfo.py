...
mnist = input_data.read_data_sets("ut5/data/", one_hot=False)  # change one_hot to false by myself ---------
# parameter_file = sys.argv[1]
# params = json.loads(open(parameter_file).read())
params = json.loads(open('ut5/parameters.json').read())
...
n_input = 28
n_steps = 28
weights = tf.Variable(tf.zeros([128, 10]))
