...
h_conv1 = tf.placeholder(tf.float32, [None, 24, 24, 32])
h_conv2 = tf.placeholder(tf.float32, [None, 8, 8, 64])
h_fc1 = tf.placeholder(tf.float32, [None, 1024])
h_fc1_drop = tf.placeholder(tf.float32, [None, 1024])
h_pool1 = tf.placeholder(tf.float32, [None, 12, 12, 32])
h_pool2 = tf.placeholder(tf.float32, [None, 4, 4, 64])
