...
X = np.random.normal(size=(100, 900))
Xte = np.random.normal(size=(30, 900))
Xtr = np.random.normal(size=(70, 900))
Yte = np.random.normal(size=(30, 62))
Ytr = np.random.normal(size=(70, 62))
batch_size = 10
n_data = 100
x = tf.placeholder(tf.float32, [None, 900])
y = np.random.normal(size=(100, 62))
